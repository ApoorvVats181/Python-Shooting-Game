    ...
    def draw(self,win):
        ...
        if self.visible:
            ...
            if self.vel>0:  #if velocity is positive it means it is moving right
                ...
                self.walkCount+=1
            pygame.draw.rect(win,(255,0,0),(self.hitbox[0],self.hitbox[1]-20,50,10)) # -20 to keep some distance between enemyand its healthbar 
...
while run:
    ...
    if keys[pygame.K_SPACE] and shootLoop==0:
        if man.left:
            ...
            facing=1            
        if len(bullets)<10: # < number of bullets
